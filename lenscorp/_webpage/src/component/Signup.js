...
const Signup = () => {
  ...
  return (
    ...
    <h1 className='text-3xl mb-6 pt-10' style={{ color: "red"}} > Signup for a new account</h1>
    ...
    <form method="post" onSubmit={handleSubmit} className='flex flex-col justify-center items-center gap-5 mt-10'>
      ...
      />
      <input 
      type="submit" value="signup" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded cursor-pointer' />
    </form>
  <Toaster/>
  </div>
